...
**Plot:** experiments/gemma-3-12b/results/lie_detector/n2000_filtered/pca_layer30_pos-letter_n2000_filtered.png
...
- **Label:** ❌ Incorrect
- **Probed Token:** `B`
- **PCA Coordinates:** (1745.45, 821.53)
...
- **Label:** ✅ Correct
- **Probed Token:** `A`
- **PCA Coordinates:** (867.32, -1399.71)
...
- **Label:** ✅ Correct
- **Probed Token:** `C`
- **PCA Coordinates:** (-1493.29, 613.55)
...
- **Label:** ✅ Correct
- **Probed Token:** `A`
- **PCA Coordinates:** (1111.57, -1374.20)
...
- **Label:** ✅ Correct
- **Probed Token:** `A`
- **PCA Coordinates:** (-168.99, -1725.30)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `C`
- **PCA Coordinates:** (-1589.92, 340.12)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `C`
- **PCA Coordinates:** (779.61, 1074.82)
...
- **Label:** ✅ Correct
- **Probed Token:** `D`
- **PCA Coordinates:** (-3743.46, -317.86)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `A`
- **PCA Coordinates:** (1112.43, -1337.31)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `A`
- **PCA Coordinates:** (842.36, -1784.30)
...
- **Label:** ✅ Correct
- **Probed Token:** `B`
- **PCA Coordinates:** (-2835.36, -232.11)
...
- **Label:** ✅ Correct
- **Probed Token:** `D`
- **PCA Coordinates:** (-1675.37, 663.78)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `B`
- **PCA Coordinates:** (-1080.07, 481.09)
...
- **Label:** ❌ Incorrect
- **Probed Token:** `A`
- **PCA Coordinates:** (2104.07, -1529.99)
...
- **Label:** ✅ Correct
- **Probed Token:** `D`
- **PCA Coordinates:** (-1054.02, 453.92)
...
- **Label:** ✅ Correct
- **Probed Token:** `B`
- **PCA Coordinates:** (-3928.57, 602.04)
...
- **Label:** ✅ Correct
- **Probed Token:** `B`
- **PCA Coordinates:** (-1624.15, 857.99)
